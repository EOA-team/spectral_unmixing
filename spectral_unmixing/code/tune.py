...
for soil_group in range(6):
    ...
    result_file = f"{results_folder}/{model_type}_tuning_PV_soilgroup{soil_group}_10k.xlsx"
    ...
    result_file = f"{results_folder}/{model_type}_tuning_NPV_soilgroup{soil_group}_10k.xlsx"
    ...
    result_file = f"{results_folder}/{model_type}_tuning_SOIL_soilgroup{soil_group}_10k.xlsx"
